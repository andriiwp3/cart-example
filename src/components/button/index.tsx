...
export default function Button({ children, className, variant = BUTTON_VARIANTS.OUTLINED, ...props }: ButtonProps) {
  return (
    <button className={clsx(BUTTON_STYLES[variant], className)} {...props}>
      {children}
    </button>
  );
}
